...
def execute(filters=None):
	data = frappe.db.sql(
		"""
		SELECT `name`, `project`, `milestone_name`, `planned_date`, `status`, `company`
		FROM `tabPM Milestone`
	...
	columns = [
		...
		{"label": _("Milestone Name"), "fieldname": "milestone_name", "fieldtype": "Data", "width": 120},
		{"label": _("Planned Date"), "fieldname": "planned_date", "fieldtype": "Date", "width": 120},
